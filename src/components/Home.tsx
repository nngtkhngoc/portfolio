    ...
    <div className="w-full items-center justify-center flex flex-col py-3 relative font-primary gap-8 md:grid md:grid-cols-2 md:px-20 xl:gap-x-10">
      <div className="w-full items-center justify-center flex flex-col  md:order-1 md:col-span-1 ">
        <motion.img
          ...
          src={pink}
          alt="icon"
          className="absolute left-5 top-10 w-[40px] h-[46px] md:left-108 xl:left-200 xl:w-[50px] xl:h-[56px]"
        />
        <motion.img
          src={green}
          alt="icon"
      ...
      <div className="text-primary text-[20px] flex flex-col items-center px-4 md:col-span-1 md:items-start w-full xl:pl-10">
        ...
        <div className="text-primary text-[14px] pt-8 px-2 md:pl-2 md:pr-0 md:pt-5 lg:pt-8 text-sm/6 text-justify w-full lg:pr-20 xl:pt-13">
